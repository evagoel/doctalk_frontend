              ...
              <div className="col-md-8 border-right">
                <div className="status p-3">
                  ...
                  <div id="extra_documents_space">
                    ...
                    <a href={`https://doctalk-backend-2-vmn0.onrender.com${doctor.documents}`} target="_blank">
                      <img src={`https://doctalk-backend-2-vmn0.onrender.com${doctor.documents}`} style={{ maxWidth: "30%" }} alt="" />
                    </a>
                  </div>
                </div>
              </div>
              <div className="col-md-4">
                <div className="p-2 text-center">
                  <div className="profile">
                    <img id="info_profile_pic" src={`https://doctalk-backend-2-vmn0.onrender.com${doctor.pic}`} width="100" style={{ height: "100px" }} className="rounded-circle img-thumbnail" alt="" />
